...
!function ($) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu '+ subStyle +'">' +
        ...
        if (this.element.is('input')) {
            this.element.on({
               ...
               // 'focus.daterangepicker': $.proxy(this.show, this), // KVELLE commented out otherwise show is triggered twice
    ...
    DateRangePicker.prototype = {
        ...
        show: function (e) {
            this.container.showDown(280, 'easeOutBounce');
            this.move();
        ...
        hide: function (e) {
            this.container.hideUp(280, 'easeOutBounce');
            if (!this.startDate.isSame(this.oldStartDate) || !this.endDate.isSame(this.oldEndDate))
                this.notify();
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate) {
            ...
            if (!minDate || minDate.isBefore(calendar[1][1])) {
                html += '<th class="prev available"><i class="fa icon-arrow-left fa fa-angle-left"></i></th>';
            } else {
                html += '<th></th>';
            }
            ...
            if (!maxDate || maxDate.isAfter(calendar[1][1])) {
                html += '<th class="next available"><i class="fa icon-arrow-right fa fa-angle-right"></i></th>';
            } else {
                html += '<th></th>';
            }
