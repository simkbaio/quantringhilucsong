...
Route::group( array( 'prefix' => 'admin', 'before' => 'auth_admin' ), function () {
	...
	Route::post( 'students/changepassword/{id}', [
		'as'   => 'admin.students.changepassword',
		'uses' => 'StudentsController@changepassword'
	] );


	Route::resource( 'teachers', 'TeachersController' );

	Route::post( 'class/{id}/addstudent', [
		'as'   => 'admin.classes.addstudent',
		'uses' => 'ClassesController@addstudent'
	] );
	Route::get( 'class/{class_id}/remove-student/{student_id}', [
		'as'   => 'admin.classes.removestudent',
		'uses' => 'ClassesController@removestudent'
	] );
	Route::post( 'class/{class_id}/add-subject', [
		'as'   => 'admin.classes.addsubject',
		'uses' => 'ClassesController@add_subject'
	] );
	Route::get( 'class/{class_id}/remove-subject/{subject_id}', [
		'as'   => 'admin.classes.removesubject',
		'uses' => 'ClassesController@remove_subject'
	] );

	Route::resource( 'classes', 'ClassesController' );
	Route::resource( 'classes.schedules', 'ClassSchedulesController' );
	Route::get( 'schedules/delete/{id}', [
		'as'   => 'admin.classes.schedules.delete',
